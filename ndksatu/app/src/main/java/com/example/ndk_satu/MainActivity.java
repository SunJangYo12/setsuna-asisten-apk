...
import com.setsunajin.asisten.MainApkExtrak;
import com.setsunajin.asisten.MainBrowser;
import com.setsunajin.asisten.MainCatatan;
import com.setsunajin.asisten.MainFileManager;
import com.setsunajin.asisten.MainKeyboard;
import com.setsunajin.asisten.MainMouse;
import com.setsunajin.asisten.MainPengaturan;
import com.setsunajin.asisten.MainSubdomner;
import com.setsunajin.asisten.MainTerminal;
import com.setsunajin.asisten.ServiceWindow;
import com.setsunajin.asisten.ServicesBoot;
...
public class MainActivity extends AppCompatActivity {
    ...
    public static String homePath = "/data/data/com.example.ndk_satu";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try {
            if (getIntent().getStringExtra("ini").equals("note")){
                showDBHistory = false;
                alertAddCatatan(this);
            }
        }catch (Exception e) {}
        ...
        btnObjviewer.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                consoleFocus();
                startActivity(new Intent(MainActivity.this, MainCatatan.class));
            }
        });
    ...
    private void alertAddCatatan(Context context) {
